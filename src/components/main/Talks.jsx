const Talks = ({ diary }) => {
  return (
    <div className="flex flex-col items-center gap-y-5 px-5">
      {diary.map((talk) => (
        <figure
          className={`grid grid-cols-1 gap-y-4 tablet:grid-cols-4 border-2 border-gray-color/50 min-w-[280px] max-w-[280px] tablet:max-w-none rounded-2xl hover:brightness-125 py-4 px-4 tablet:py-0 bg-gradient-to-bl from-transparent via-transparent to-op-primary-color backdrop-blur transition-all duration-300  desktop:w-full ${
